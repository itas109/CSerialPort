...
// ** only reserve two paramete function for CSerialPort 4.X 2022-11-13 itas109 **
...
namespace sigslot {
	...
	{
	public:
		typedef typename std::list<_connection_base2<arg1_type, arg2_type, mt_policy> *> connections_list;
