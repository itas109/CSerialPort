// CSerialPortDemoWin32.cpp : 定义应用程序的入口点。
//
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_CSERIALPORTDEMOWIN32, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_CSERIALPORTDEMOWIN32));

	//串口初始化
	HWND hSerialPort = ::FindWindow(_T("CSerialPortDemoWin32"), NULL);
	m_SerialPort.InitPort(hSerialPort, 2);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_CSERIALPORTDEMOWIN32));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_CSERIALPORTDEMOWIN32);
